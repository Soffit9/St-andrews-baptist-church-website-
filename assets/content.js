...
function videoEmbedHtml(url, heightPx) {
  ...
  if (/facebook\.com/i.test(str)) {
    ...
    return `<iframe src="https://www.facebook.com/plugins/video.php?href=${encoded}&show_text=false" width="100%" height="${heightPx || 315}" style="border:0;overflow:hidden;max-width:100%" scrolling="no" frameborder="0" allowfullscreen allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>`;
  }
