document.addEventListener("DOMContentLoaded", () => {
  ...
  if (prayerForm) {
    ...
    prayerForm.addEventListener("submit", e => {
      ...
      document.querySelector("#form-message").className = "success";
      document.querySelector("#form-message").textContent =
        "Prototype only — this will be connected to the church's prayer request Google Form so Pastor Ladd can read it directly.";
      prayerForm.reset();
